...
export default function PurchaseOrders() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log('📊 Loaded PO data:', {
        orders: purchaseOrdersData.length,
        items: purchaseOrderItemsData.length,
        autoGenerated: purchaseOrdersData.filter(po => po.notes?.includes('AUTO-GENERATED')).length
      });
      ...
      <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Button 
            ...
            className="bg-white/50 backdrop-blur-sm"
            onClick={() => {
              const autoGenerated = purchaseOrders.filter(po => po.notes?.includes('AUTO-GENERATED'));
              toast({
                title: "Auto-Generated POs",
                description: `Found ${autoGenerated.length} auto-generated purchase orders from production planning`,
                variant: "default",
              });
            }}
          >
            <Package className="h-4 w-4 mr-2" />
            Auto POs ({purchaseOrders.filter(po => po.notes?.includes('AUTO-GENERATED')).length})
          </Button>
        </div>
      </div>
